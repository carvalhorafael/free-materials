...
MAIN_FILE="${ROOT_DIR}/free-materials.php"
...
perl -0pi -e "s/define\\( 'FREE_MATERIALS_VERSION', '\\Q${current_version}\\E' \\);/define( 'FREE_MATERIALS_VERSION', '${next_version}' );/" "${MAIN_FILE}"
